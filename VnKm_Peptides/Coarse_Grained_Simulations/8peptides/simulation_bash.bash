...
#We have run this simulation on the following GROMACS versions : GROMACS 2016.6 and 2018.3
...
input=conf_8_peptides # Name of the input coordinate file, i.e. the CG coordinates Mapped onto the AA system; We have used the csg_map tool in VOTCA-CSG to generate this configuration. For more information, please check out the VOTCA-CSG manual https://www.votca.org/csg/index.html
...
NDX=index_8.ndx ## the index file of all coordinates and energy groups in the system. 
...
## For Gromacs 2016.6 and 2018.3, use the following: 
...
## For Gromacs 5.1.2, you may need to use it in the following mannner: $exp_grompp mdrun  -deffnm $tpr -v 
